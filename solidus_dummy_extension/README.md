...
Add solidus_dummy_extension to your Gemfile:

```ruby
gem 'solidus_dummy_extension'
```

Bundle your dependencies and run the installation generator:

```shell
bin/rails generate solidus_dummy_extension:install
```
...
```ruby
require 'solidus_dummy_extension/testing_support/factories'
```
